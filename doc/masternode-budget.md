...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CATS, _12_ times over the course of a year totaling _24000_ CATS.
...
When block `1000000` is reached you'll receive a payment for `1200` CATS.
