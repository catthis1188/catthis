...
```bash
    ...
    From https://github.com/catthis/catthis
...
For example:
```bash
URL=https://github.com/konez2k/catthis.git
...
[catthis/gitian.sigs](https://github.com/catthis/gitian.sigs/) repository, or if that's not possible to create a pull
request.
