...
This mechanism has been integrated into Bitcore-Node-CATScoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/catthis/insight-api-catthis#web-socket-api](https://github.com/catthis/insight-api-catthis#web-socket-api)
* API: [https://github.com/catthis/insight-api-catthis#swifttx-transactions](https://github.com/catthis/insight-api-catthis#swifttx-transactions)
