...
In order to support loading of multiple wallets in catthis-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is catthis.cpp.
...
Changes to catthis.cpp
----------------------
catthis.cpp is the entry point into catthis-qt, and as such, will require some minor modifications to provide hooks for
