...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000005a661ac43ced6a37f6ca22ed517fbda391f66cf3aa46e2cc67c8651e6ae"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526403518, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("045ad6f1551c2367f81c9ecb4d45d088298442887645a314dfcba3039401872473b0200e69d9679a0d7cc307fb9aaaacafb0cebc18050ce7c995fa19c6accc8415");
        nDefaultPort = 4133;
        ...
        nTargetSpacing = 2 * 60;  // catTHIS: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for CATS

        const char* pszTimestamp = "Start Catthis Coin, 15th may,2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1526403518;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 174521;

		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000005a661ac43ced6a37f6ca22ed517fbda391f66cf3aa46e2cc67c8651e6ae"));
        ...
        // catTHIS BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // catTHIS BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // catTHIS BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // catTHIS: 1 day
        nTargetSpacing = 2 * 60;  // catTHIS: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nNonce = 289760;

		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000094fbd71ac5d992672a600acf9d0055646bfb6945d1b9c988c3745716760"));
        ...
        // Testnet catTHIS script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet catTHIS BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet catTHIS BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 2 * 60;        // catTHIS: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 24133;
        assert(hashGenesisBlock == uint256("0x1cc30b607e2fd2d0687a41ffea72015d256e86191f0aa9ff34581ab00bc4b5fe"));
