...
#   c) node1 mines 32 blocks, so now node 0 has 500000CATS, node 1 has 4250CATS, node2 has none.
#   d) node0 sends 601 CATS to node2, in two transactions (301 CATS, then 300 CATS).
